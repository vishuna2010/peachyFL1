  ...
  <header class="bg-venus-background shadow-md sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
      ...
      <div class="flex items-center space-x-4">
        ...
        <!-- Conditional Auth Links: Only render when auth state is initialized -->
        <div v-if="isAuthInitialized" class="flex items-center space-x-4">
        ...
        <!-- Optional: Placeholder for auth links while loading -->
        <!-- <div v-else class="h-6 w-24"></div> -->
