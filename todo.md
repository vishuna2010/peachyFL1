...
- **Product-Specific Variant UI (likely within product edit page `/admin/products/edit/[id].vue` or a dedicated sub-page):**
  ...
  - Create/edit/delete variants based on combinations of these values (setting SKU, price modifier, stock, image). (Display of existing variants, Add Variant form structure, and Add Variant logic implemented; Edit/Delete logic pending).
