  ...
  <div class="bg-white border border-venus-neutral-light rounded-sm overflow-hidden flex flex-col group relative transition-all duration-300 ease-in-out hover:shadow-lg">
    <div class="relative">
      ...
      <button
        ...
        class="absolute bottom-4 left-1/2 -translate-x-1/2 w-10/12 bg-peach-pink text-white text-sm font-semibold px-4 py-2.5 rounded-md shadow-md opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-peach-pink"
      >
        Quick View
      </button>
